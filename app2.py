...
def load_models():
    # 加载 12 特征模型
    models_12 = {
        1: joblib.load('./selected_features/catboost_op_sm_1yr.pkl'),
        3: joblib.load('./selected_features/catboost_op_sm_3yr.pkl'),
        5: joblib.load('./selected_features/catboost_op_sm_5yr.pkl')
    }
